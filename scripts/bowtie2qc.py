...
def main(path_to_samples, reference_genome, current_directory, out_file_string):
    ...
    os.system("grep exactly logs/bowtie2_*_ref_" + reference_genome + ".txt" " >> " + cwd + "/" + out_file_string + ".txt")
    os.system("grep overall logs/bowtie2_*_ref_" + reference_genome + ".txt" " >> " + cwd + "/" + out_file_string + ".txt") 
